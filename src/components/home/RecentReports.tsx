            ...
            <div className="container mx-auto px-4">
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {items.map((item) => {
                        ...
                        if (!itemId) return (
                            <div key={Math.random()} className="h-full p-5 rounded-xl border border-red-200 bg-red-50">
                                <span className="text-red-500 font-bold">Error: Item sin ID</span>
                            </div>
                        )

                        return (
                            <Link key={itemId} href={`/item/${itemId}`} className="group block">
